...
//         Easy Accuracy : 51.02 %
//     Submissions : 6738 Points : 2

//     Given a number n.The task is to find the smallest number whose factorial contains at least n trailing zeroes.

//     Example 1 :

//     Input : n = 1 Output : 5 Explanation : 5 ! = 120 which has at
//     least 1 trailing 0.
...
{
    int low = 1;
    int high = 5 * n; // we have n trailing zeros in 5*n! as we have n 5's in prime factor of 5*n
